...
public class TabPane extends Table {
   ...
   /**
    * Get the {@link TabContainer} at the specified index. Start from 0.
    * 
    * @param index
    *           position of the {@link Tab} of the {@link TabContainer}
    ...
    * 
    * @param clazz
    *           the type of the searched {@link TabCOntainer}
    * @return the first found {@link TabContainer} of the searched type or null
    *         if nothing is found
    */
